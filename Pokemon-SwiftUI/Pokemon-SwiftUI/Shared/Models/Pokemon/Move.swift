...
struct Move: Codable {
    ...
    var contestType: PokemonInfoResponse
    var damageClass: PokemonInfoResponse
    ...
    var target, type: PokemonInfoResponse
...
struct ContestComboDetail: Codable {
    var useAfter:  [PokemonInfoResponse]
    var useBefore: [PokemonInfoResponse]?
